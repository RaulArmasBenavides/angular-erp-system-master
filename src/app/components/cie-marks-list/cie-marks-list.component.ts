...
export class CieMarksListComponent implements OnInit {
	...
	constructor(private readonly cieService: CieEntryService) {}
	...
	saveData(): void {
		...
		if (
			this.dataSource.some(
				(data: any) => !data.prn || !data.srn || !data.studentName || !data.totalCie || !data.cie1 || !data.cie2 || !data.cie2
			)
		) {
